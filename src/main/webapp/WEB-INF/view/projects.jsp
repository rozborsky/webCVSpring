	...
	<jsp:include page="header.jsp" />
		...
		<div class="table-responsive">
        	<table class="table">
                <tr>
					<td>
					    <button type="button" class="btn btn-default btn-project">NYC cab</button>
					</td>
					<td>
                        Web page that takes the initial or final position, which is a taxi and the trip time
                        and returns the user to the likelihood of travel in each of the five districts of the city.
                        In this scenario uses data from the New York taxi.
					</td>
					<td><a href="https://github.com/rozborsky/NYCcab">see code <i class="fa fa-github" aria-hidden="true"></i></a></td>
				</tr>
				<tr>
                    <td>
